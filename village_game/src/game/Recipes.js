...
export const Recipes = {
    ...
    turret_stone: { type: 'turret', subType: 'stone', cost: { stone: 20 }, description: "Slow but heavy hitting stone turret." },
    ...
    wood_col: {
        ...
        subType: 'wood_col',
        cost: { wood: 50 },
        description: "Auto-collects nearby Wood."
    },
    stone_col: {
        type: 'collector',
        subType: 'stone_col',
        cost: { stone: 50 },
        description: "Auto-collects nearby Stone."
    },
    iron_col: {
        type: 'collector',
        subType: 'iron_col',
        cost: {iron: 50 },
        description: "Auto-collects nearby Iron."
    },
    universal_col: {
        type: 'collector',
        subType: 'universal_col',
        cost: { wood: 100, stone: 100 },
        description: "Auto-collects nearby all resources."
    },
    collector_novice: {
        type: 'collector',
        subType: 'collector_novice',
        cost: { wood: 20, stone: 20 },
        description: "Slowly collects all resources."
    },
    ...
    // Seeds
    seed_wood: { type: 'seed', subType: 'tree', cost: { wood: 10 }, description: "Plants a Tree." },
    seed_stone: { type: 'seed', subType: 'rock', cost: { wood: 20 ,stone:1}, description: "Plants a Rock." },
    seed_iron: { type: 'seed', subType: 'iron', cost: { wood: 20 ,iron:1}, description: "Plants Iron ore." },
    seed_crystal: { type: 'seed', subType: 'crystal', cost: { wood: 20 ,crystal:1}, description: "Plants Crystal." },
    seed_obsidian: { type: 'seed', subType: 'obsidian', cost: { wood: 20 ,obsidian:1}, description: "Plants Obsidian." },
    seed_diamond: { type: 'seed', subType: 'diamond', cost: { wood: 20 ,diamond:1}, description: "Plants Diamond." },
    seed_emerald: { type: 'seed', subType: 'emerald', cost: { wood: 20 ,emerald:1}, description: "Plants Emerald." },
    seed_ruby: { type: 'seed', subType: 'ruby', cost: { wood: 20 ,ruby:1}, description: "Plants Ruby." },
    seed_sapphire: { type: 'seed', subType: 'sapphire', cost: { wood: 20 ,sapphire:1}, description: "Plants Sapphire." },
};
